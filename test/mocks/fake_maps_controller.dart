...
class FakePlatformGoogleMap {
  ...
  Future<dynamic> onMethodCall(MethodCall call) {
    switch (call.method) {
      ...
      case 'tileOverlays#update':
        updateTileOverlays(
            Map.castFrom<dynamic, dynamic, String, dynamic>(call.arguments as Map<dynamic, dynamic>));
        return Future<void>.sync(() {});
      case 'circles#update':
  ...
  void updateMarkers(Map<dynamic, dynamic>? markerUpdates) {
    ...
    markerIdsToRemove =
        _deserializeMarkerIds(markerUpdates['markerIdsToRemove'] as List<dynamic>);
  ...
  void updatePolygons(Map<dynamic, dynamic>? polygonUpdates) {
    ...
    polygonIdsToRemove =
        _deserializePolygonIds(polygonUpdates['polygonIdsToRemove'] as List<dynamic>?);
  ...
  List<List<LatLng>> _deserializeHoles(List<dynamic> holes) {
    return holes.map<List<LatLng>>((dynamic hole) {
      return holes.map<LatLng>((dynamic list) {
        return LatLng(list[0] as double, list[1] as double);
      }).toList();
    }).toList();
  }
  ...
  void updatePolylines(Map<dynamic, dynamic>? polylineUpdates) {
    ...
    polylineIdsToRemove =
        _deserializePolylineIds(polylineUpdates['polylineIdsToRemove'] as List<dynamic>?);
    polylinesToChange =
  ...
  void updateCircles(Map<dynamic, dynamic>? circleUpdates) {
    ...
    circleIdsToRemove =
        _deserializeCircleIds(circleUpdates['circleIdsToRemove'] as List<dynamic>?);
  ...
  void updateTileOverlays(Map<String, dynamic> updateTileOverlayUpdates) {
    ...
    updateTileOverlayUpdates['tileOverlayIdsToRemove'] != null
        ...
        updateTileOverlayUpdates['tileOverlayIdsToRemove'] as List<dynamic>)
        : null;
  ...
  void updateOptions(Map<dynamic, dynamic> options) {
    ...
    if (options.containsKey('minMaxZoomPreference')) {
      ...
      minMaxZoomPreference =
          MinMaxZoomPreference(minMaxZoomList[0] as double?, minMaxZoomList[1] as double?);
    }
